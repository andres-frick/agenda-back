...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://AndresFrick:codoacodo@AndresFrick.mysql.pythonanywhere-services.com/proyecto'
...
# TODO: Crear estruct "Contacto" 
# id, nombre, telefono, mail, direccion
